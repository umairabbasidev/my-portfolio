      ...
      <Grid item md={6}>
        <Container sx={{ paddingY: 22 }}>
          ...
          <Typography
            variant="h3"
            component="h4"
            sx={{ textAlign: { xs: "center", md: "left", color: "orange" } }}
            textAlign="center"
          >
            Landing Page
          </Typography>
          ...
          >
            ...
            <Box className="icon">
             ...
             <a href="https://twitter.com/umairabbasidev"target="_blank" > <Twitter sx={{ color: "orange", margin: "5px 10px" }} /> </a>
              
              <a href="mailto:muhammadumairabbasi637@gmail.com" target="_blank"><Email sx={{ color: "orange", margin: "5px 10px" }} /></a>
              <a href="https://wa.me/+923302048095" target="_blank"><WhatsApp sx={{ color: "orange", margin: "5px 10px" }} /></a>
      ...
      <Grid item>
        <Box>
          <img
            ...
            width={320}
            height={450}
            style={{ borderRadius: 5, boxShadow: "-3px -2px 8px gray" }}
          />
        </Box>
      </Grid>
    </Grid>
